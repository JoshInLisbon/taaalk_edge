...
ActiveRecord::Schema.define(version: 2020_06_29_152438) do
  ...
  create_table "draft_msgs", force: :cascade do |t|
    ...
    t.bigint "tlk_id", null: false
    t.bigint "spkr_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "new_spkrs", force: :cascade do |t|
    t.string "name"
    t.string "bio"
    t.string "email"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "spkrs", force: :cascade do |t|
    t.bigint "tlk_id", null: false
    t.bigint "user_id", null: false
    t.string "name"
    t.string "bio"
    ...
    t.string "side"
    t.string "color"
    t.string "edited_color"
    t.string "twitter_handle"
    t.string "edited_twitter_handle"
    t.boolean "auto_tweet_on", default: true
    t.boolean "to_reply", default: false
